            ...
            <div className="flex min-h-screen items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="text-lg text-slate-600">
                        {authenticating ? "Verifying authentication..." : "Loading blog..."}
                    </div>
                </div>
            </div>
        );
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        <div>
                            ...
                            {image1 && (
                                <div className="relative mt-4 h-48 w-full overflow-hidden rounded-lg">
                                    <Image
                                        src={image1.startsWith("/") ? image1 : `/uploads/blogs/${image1}`}
                                        alt="Preview"
                                        fill
                        ...
                        <div>
                            ...
                            {image2 && (
                                <div className="relative mt-4 h-48 w-full overflow-hidden rounded-lg">
                                    <Image
                                        src={image2.startsWith("/") ? image2 : `/uploads/blogs/${image2}`}
                                        alt="Preview"
                                        fill
                                        className="object-cover"
                                    />
